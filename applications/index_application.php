...
<div id="dashboard">
      <div class="scroll con">
        ...
        <div class="featurette" id="services">
            <img class="featurette-image img-circle img-responsive pull-left" src="img/profile-avatar.jpg">
            <h2 class="featurette-heading">Welcome!
               
            </h2>
            <p class="lead">Thank you so much for visiting the Wildlife Center. We could not do what we do without our lovely volunteers like you. Get out there and get to work!</p>
        </div>
